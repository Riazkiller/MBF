...
def results(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print("├  Subscribe My Channel: https://www.facebook.com/Riaz-hacker-100835532473815/           ┤")
        print("├  Subscribe My Channel: https://www.facebook.com/Riaz-hacker-100835532473815/          ┤")
        print("├  Like And Follow My Facebook Page: https://www.facebook.com/Riaz-hacker-100835532473815/   ┤")
        print("├  Like And Follow My Facebook Page: https://www.facebook.com/Riaz-hacker-100835532473815/┤")
        print   '\033[0;97m└'+48*'─'+ '┘'
...
def login():
	...
	try:
		...
		print("├             └────────────────────┘             ┤")
		print   '├     \033[0;97m├'+35*'─'+ '┐      ┤'
		print("\033[0;97m├     |🌹Author   : ꧁☠ℜ𝔦𝔞𝔷☠️꧂           🌹|      ┤")
		print("\033[0;97m├     |🌹GitHub   : github.com/Riazkiller🌹|      ┤")
		print("\033[0;97m├     |🌹Facebook : https://www.facebook.com/Riaz-hacker-100835532473815/   🌹|      ┤")
		print   '├     \033[0;97m└'+35*'─'+ '┘      ┤'
		print   '\033[0;97m└'+48*'─'+ '┘'
#	try:
	zmbf()
